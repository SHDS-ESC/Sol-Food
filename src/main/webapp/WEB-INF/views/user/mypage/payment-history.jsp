    ...
    <script>
        $(document).ready(function() {
            ...
            function loadPaymentHistory(page) {
                ...
                $.ajax({
                    url: '${pageContext.request.contextPath}/payments/payment/history',
                    type: 'GET',
                    data: {
                        page: page,
                        size: pageSize
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            alert('결제 내역 조회 실패: ' + response.message);
                            $('#no-data').show();
                        }
                    },
                    error: function(xhr, status, error) {
                        $('#loading').hide();
                        alert('결제 내역 조회 중 오류가 발생했습니다: ' + error);
                        $('#no-data').show();
                    }
                });
            }
            ...
            window.cancelPayment = function(impUid, cancelAmount, cancelReason) {
                ...
                $.ajax({
                    url: '${pageContext.request.contextPath}/payments/payment/cancel',
                    type: 'POST',
