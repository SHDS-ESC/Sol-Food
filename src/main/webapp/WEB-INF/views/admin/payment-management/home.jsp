  ...
  <style>
    ...
    * { font-family: 'Inter', sans-serif; }
    ...
    .side-menu {
      ...
      background: var(--sidebar-bg); border-right:1px solid #dee2e6;
    ...
    .side-menu .nav-link {
      ...
      margin-bottom:1rem; border-radius:.375rem; padding:.5rem 1rem;
    ...
    .search-bar input,
    .search-bar select { font-size:12px; }
    .search-bar button { min-width:100px; }
    .page-selector {
      background:#f8f9fa; border:1px solid #dee2e6;
      border-radius:.375rem; padding:.5rem; margin-bottom:1rem;
    }
    .table thead th {
      background:#e6f4ea; color:#198754;
      font-weight:700; border-bottom:2px solid #b7e4c7;
    ...
    .status-inactive {
      ...
      background:#fee2e2; padding:.25rem .75rem;
      border-radius:.5rem; font-size:.875rem;
    }
    #custom-nav { display:flex; justify-content:center; margin-top:1rem; }
  </style>
</head>
...
<div class="d-flex">
  ...
  <nav class="side-menu">
    ...
    <a href="${pageContext.request.contextPath}/admin/home/owner-management" class="nav-link">점주</a>
    <a href="${pageContext.request.contextPath}/admin/home/payment-management" class="nav-link active">결제</a>
