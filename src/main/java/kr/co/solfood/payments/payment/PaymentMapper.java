...
public interface PaymentMapper extends CommonPaymentMapper {
    ...
    /**
     * 사용자별 진행중인 결제 조회 (pending 상태)
     */
    List<PaymentVO> selectOngoingPaymentByUserId(@Param("userId") long userId);
     ...
     */
    List<Map<String, Object>> selectOngoingPaymentByUserIdWithExpiration(@Param("userId") long userId);
      ...
      * merchant_uid 중복 체크
      */
     boolean isMerchantUidAlreadyUsed(@Param("merchantUid") String merchantUid);
 }
